...
edgeStrength1 = pm_rescaler(graphicalModel1);
edgeStrength2 = pm_rescaler(graphicalModel2);
...
%figure(2)
[h2a,h2b]=pm_image_plot(edgeStrength2, edgeStrength1,[0.775 0.81], names, z_blocks, z_lbls);
h = colorbar(cb_props{:});
